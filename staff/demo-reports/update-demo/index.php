...
if(isset($_POST['btn_update'])){
	...
	$q="Update demo set remark = '".$_POST['text_remark']."', visit_status = '".$_POST['text_demo_status']."', visit_date = '".$_POST['text_demo_date']."', type = '".$_POST['text_demo_type']."', client_uid = '".$_POST['text_client_uid']."' where uid='".$_GET['id']."'";
	$r=mysqli_query($cn,$q);
	if($r){
