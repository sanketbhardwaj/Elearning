...
<head>
    ...
    <title><?php echo $row_title[3]; ?> | List of Tickets</title>
          ...
          <div class="row">
            ...
            <div class="col s12">
              <table id="data-table-simple" class="display">
                ...
                <tbody>
				<?php
				$sql_c="select issue, support_uid, client_uid, solve_by, is_solve, remark, call_duration, uid, date_time from tickets where support_uid = '".$_SESSION['staff_uid']."'";
				  ...
				  if($row_c[4]=="Pending"){ echo "color:red;"; }elseif($row_c[4]=="In Progress") { echo "color:orange;"; }elseif($row_c[4]=="Completed") { echo "color:green;"; } ?>">
					...
					<p>
						<form action="" method="POST">
							...
							<a href="update-tickets/?id=<?php echo $row_c[7]; ?>" class="mb-6 btn-floating waves-effect waves-light orange darken-1">
