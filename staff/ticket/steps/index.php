...
if(isset($_POST['btn_save'])){
	...
	$q="Update tickets set remark = '".$_POST['text_remark']."', solve_by = support_uid, is_solve='Completed', solve_date='".$cur_date."' where uid='".$_GET['ticket_id']."'";
	$r=mysqli_query($cn,$q);
	if($r){
				  ...
				  <div class="row">
					<form class="col s12" method="POST" action="" enctype="multipart/form-data">
					  <div class="row">
						...
						$sql_c="select * from tickets where uid = '".$_GET['ticket_id']."'";
