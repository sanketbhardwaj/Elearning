          ...
          <div class="row">
            ...
            <div class="col s12">
              <table id="data-table-simple" class="display">
                ...
                <tbody>
				<?php
				$sql_c="select client_uid, payment, payment_mode, payment_id, reminder_date, transaction_status, uid, datetime from transaction where staff_uid = '".$_SESSION['staff_uid']."'";
