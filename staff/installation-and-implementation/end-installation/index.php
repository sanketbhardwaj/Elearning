...
if(isset($_POST['btn_save'])){
	...
	$cur_date=date('Y-m-d H:i:s',$time_now);
	
	$q="Update installation set remark = '".$_POST['text_remark']."', end_on='".$cur_date."', installation_status='Completed', type='".$_POST['text_type']."' where uid='".$_GET['id']."'";
	$r=mysqli_query($cn,$q);
	if($r){
		?><script>if(!alert("End Installation!")) document.location = '../';</script><?php
	}else{
...
<head>
    ...
    <title><?php echo $row_title[3]; ?> | End Installations</title>
				...
				<div class="card-title">
				  <div class="row">
					<div class="col s12 m6 l10">
					  <h4 class="card-title">End Installations</h4>
					</div>
				  </div>
				</div>
				<div id="view-icon-prefixes">
				  ...
				  <div class="row">
					<form class="col s12" method="POST" action="" enctype="multipart/form-data">
					  <div class="row">
					  <?php
						$sql_c="select * from installation where uid = '".$_GET['id']."'";
