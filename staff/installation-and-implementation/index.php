...
if(isset($_POST['btn_start'])){
	...
	$q="Update installation set start_on='".$date_time."' where uid = '".$_POST['uid']."'";
	$r=mysqli_query($cn,$q);
		
	?><script>if(!alert("Installation Started!")) document.location = '';</script><?php
...
<head>
    ...
    <title><?php echo $row_title[3]; ?> | List of Installation</title>
    ...
    <div class="col s12 m12 l12">
      <div id="button-trigger" class="card card card-default scrollspy">
        <div class="card-content">
          <h4 class="card-title">All Installation</h4>
          <div class="row">
            ...
            <div class="col s12">
              <table id="data-table-simple" class="display">
				...
				$sql_c="select * from installation where staff_uid = '".$_SESSION['staff_uid']."' AND installation_date <= '".$date_time."' AND installation_status = 'Pending' ORDER BY id DESC";
				...
				?>
                  <tr>
					...
					if($row_c[6]=="0000-00-00 00:00:00"){
						...
						?>
						<td><a href="end-installation/?id=<?php echo $row_c[1]; ?>" class="mb-6 btn waves-effect waves-light red darken-1">End Installation</a></td>
						<?php
					}
					?>
