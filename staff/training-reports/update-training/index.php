...
if(isset($_POST['btn_update'])){
	...
	$q="Update training set remark = '".$_POST['text_remark']."', training_status = '".$_POST['text_training_status']."', training_date = '".$_POST['text_training_date']."', type = '".$_POST['text_training_type']."', client_uid = '".$_POST['text_client_uid']."' where uid='".$_GET['id']."'";
	$r=mysqli_query($cn,$q);
	if($r){
