...
$ext = "../";
$menu = "report_training";

if(isset($_POST['btn_delete'])){
	
	
	$q="Delete from training where uid = '".$_POST['uid']."'";
	$r=mysqli_query($cn,$q);
          ...
          <div class="row">
            ...
            <div class="col s12">
              <table id="data-table-simple" class="display">
                ...
                <tbody>
				<?php
				$sql_c="select training_date, staff_uid, client_uid, training_status, start_on, end_on, remark, uid from training where staff_uid = '".$_SESSION['staff_uid']."'";
				...
				?>
				  ...
				  if($row_c[3]=="Pending"){ echo "color:red;"; }elseif($row_c[3]=="In Progress") { echo "color:orange;"; }elseif($row_c[3]=="Completed") { echo "color:green;"; } ?>">
                    ...
                    <td><b><?php echo $row_c[3];?></b></td>
                    
                    <td>
					<p>
						<form action="" method="POST">
							<input type="hidden" name="uid" value="<?php echo $row_c[7]; ?>">
							<a href="update-training/?id=<?php echo $row_c[7]; ?>" class="mb-6 btn-floating waves-effect waves-light orange darken-1">
