...
if(isset($_POST['btn_update'])){
	...
	$date_time=date('Y-m-d H:i:s',$time_now);
		...
		if(file_exists($_FILES['text_quotation']['tmp_name'])){
			...
			$q="Update quotations set staff_uid = '".$_POST['text_sales_uid']."', quote_amount = '".$_POST['text_sw_final_price']."', quote_status = 'Confirmed' WHERE client_uid = '".$_GET['id']."' AND quote_no = '".$_POST['text_quotation']."'";
			$r=mysqli_query($cn,$q);
		}
