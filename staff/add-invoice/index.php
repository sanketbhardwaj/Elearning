...
if(isset($_POST['btn_save'])){
	...
	$q="INSERT INTO invoices VALUES (NULL, '".$uid."','".$date_time."','".$_POST['text_client_uid']."','".$_SESSION['staff_uid']."','".$_POST['text_invoice']."','".$_POST['text_price']."','".$file_names."','Pending','Active')";
	$r=mysqli_query($cn,$q);
