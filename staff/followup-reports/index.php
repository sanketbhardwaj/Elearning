          ...
          <div class="row">
            ...
            <div class="col s12">
              <table id="data-table-simple" class="display">
                ...
                <tbody>
				<?php
				$sql_c="select * from followups where staff_uid = '".$_SESSION['staff_uid']."' ORDER BY id DESC";
				...
				while($row_c=mysqli_fetch_array($result_c))
				{
					...
					$sql_client="select name, business_name from client where uid = '$row_c[4]'";
				...
				?>
				  ...
				  if($row_c[5]=="Pending"){ echo "color:red;"; }elseif($row_c[5]=="In Progress") { echo "color:orange;"; }elseif($row_c[5]=="Completed") { echo "color:green;"; } ?>">
                    ...
                    <td><?php echo $row_client[0]." (".$row_client[1].")";?></td>
