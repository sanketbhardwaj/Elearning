          ...
          <div class="row">
            ...
            <div class="col s12">
              <table id="data-table-simple" class="display">
                ...
                <tbody>
				<?php
				$sql_c="select installation_date, staff_uid, client_uid, installation_status, start_on, end_on, remark, uid from installation where staff_uid = '".$_SESSION['staff_uid']."'";
