...
if(isset($_POST['btn_reject'])){
	...
	$q="Update client set client_status='Reject' where uid = '".$_POST['client_uid']."'";
	$r=mysqli_query($cn,$q);
	
	$q="Update followups set follow_status='Completed' where uid = '".$_POST['uid']."'";
	$r=mysqli_query($cn,$q);
	
	$q="Update client_staff set software_status='Reject' where uid = '".$_POST['client_uid']."'";
	$r=mysqli_query($cn,$q);
	
	
		
	?><script>if(!alert("Rejected!")) document.location = '';</script><?php
...
<head>
    ...
    <title><?php echo $row_title[3]; ?> | List of Followups</title>
    ...
    <div class="col s12 m12 l12">
      <div id="button-trigger" class="card card card-default scrollspy">
        <div class="card-content">
          <h4 class="card-title">All Followups</h4>
          <div class="row">
            ...
            <div class="col s12">
              <table id="data-table-simple" class="display">
				...
				$sql_c="select * from followups where staff_uid = '".$_SESSION['staff_uid']."' AND next_date<='".$date_time."' AND follow_status = 'Pending' ORDER BY id DESC";
				...
				?>
                  <tr>
					...
					<td><a href="next-call/?id=<?php echo $row_c[1]; ?>" class="mb-6 btn waves-effect waves-light orange darken-1">Next Call</a></td>
                    <td>
					<p>
						<form action="" method="POST">
							<input type="hidden" name="uid" value="<?php echo $row_c[1]; ?>">
							<input type="hidden" name="client_uid" value="<?php echo $row_c[4]; ?>">
							<a href="confirm-client/?id=<?php echo $row_c[4]; ?>" class="mb-6 btn waves-effect waves-light green darken-1">
								Confirm
							</a>
							<button type="submit" name="btn_reject" class="mb-6 btn waves-effect waves-light red darken-1">
								Reject
							</button>
						</form>
					</p>
