...
<head>
    ...
    <title><?php echo $row_title[3]; ?> | List of Clients</title>
          ...
          <div class="row">
            ...
            <div class="col s12">
              <table id="data-table-simple" class="display">
                ...
                <tbody>
				<?php
				$sql_c="select name, business_name, email, mobile1, uid, date_time from client where client_status = 'Confirmed' AND (sales_uid = '".$_SESSION['staff_uid']."' || support_uid = '".$_SESSION['staff_uid']."')";
				...
				?>
                  <tr>
					...
					<td><a href="../manage-clients-product/?id=<?php echo $row_c[4]; ?>" class="mb-6 btn waves-effect waves-light green darken-1">View</a></td>
                    <td>
					<p>
						<form action="" method="POST">
							<input type="hidden" name="uid" value="<?php echo $row_c[4]; ?>">
							<a href="update-client/?id=<?php echo $row_c[4]; ?>" class="mb-6 btn-floating waves-effect waves-light orange darken-1">
