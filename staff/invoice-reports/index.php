...
<head>
    ...
    <title><?php echo $row_title[3]; ?> | List of Invoice</title>
          ...
          <div class="row">
            ...
            <div class="col s12">
              <table id="data-table-simple" class="display">
                ...
                <tbody>
				<?php
				$sql_c="select * from invoices where staff_uid = '".$_SESSION['staff_uid']."'";
				...
				?>
				  ...
				  if($row_c[8]=="Pending"){ echo "color:red;"; }elseif($row_c[8]=="In Progress") { echo "color:orange;"; }elseif($row_c[8]=="Confirmed") { echo "color:green;"; } ?>">
                    ...
                    <td><a href="<?php echo "../../files/".$row_c[7];?>">View Invoice</a></td>
