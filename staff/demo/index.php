...
if(isset($_POST['btn_start'])){
	...
	$q="Update demo set start_on='".$date_time."' where uid = '".$_POST['uid']."'";
	$r=mysqli_query($cn,$q);
		
	?><script>if(!alert("Demo Started!")) document.location = '';</script><?php
          ...
          <div class="row">
            ...
            <div class="col s12">
              <table id="data-table-simple" class="display">
				...
				$sql_c="select * from demo where staff_uid = '".$_SESSION['staff_uid']."' AND demo_date <= '".$date_time."' AND demo_status = 'Pending' ORDER BY id DESC";
				...
				?>
                  <tr>
					...
					if($row_c[6]=="0000-00-00 00:00:00"){
						...
						?>
						<td><a href="end-demo/?id=<?php echo $row_c[1]; ?>" class="mb-6 btn waves-effect waves-light red darken-1">End Demo</a></td>
						<?php
					}
					?>
