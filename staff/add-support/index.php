...
if(isset($_POST['btn_save'])){
	$fname = substr($_POST['text_issue'], 0,1);
	...
	$q="INSERT INTO tickets VALUES (NULL, '".$uid."','".$date_time."','".$_SESSION['staff_uid']."','".$_POST['text_client_uid']."','".$_POST['text_issue']."','','Pending','','','Active','".$_POST['text_answer']."','".$file_names."','".$_POST['text_url']."','')";
	$r=mysqli_query($cn,$q);
					...
					<form class="col s12" method="POST" action="" enctype="multipart/form-data">
					  <div class="row">
						<div class="input-field col s12">
							<select name="text_client_uid" required>
