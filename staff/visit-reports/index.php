...
if(isset($_POST['btn_delete'])){
	...
	$q="Delete from visits where uid = '".$_POST['uid']."'";
	$r=mysqli_query($cn,$q);
...
<head>
    ...
    <title><?php echo $row_title[3]; ?> | List of Visits</title>
          ...
          <div class="row">
            ...
            <div class="col s12">
              <table id="data-table-simple" class="display">
                ...
                <tbody>
				<?php
				$sql_c="select visit_date, staff_uid, client_uid, visit_status, start_on, end_on, remark, uid from visits where staff_uid = '".$_SESSION['staff_uid']."'";
				  ...
				  if($row_c[3]=="Pending"){ echo "color:red;"; }elseif($row_c[3]=="In Progress") { echo "color:orange;"; }elseif($row_c[3]=="Completed") { echo "color:green;"; } ?>">
					...
					<p>
						<form action="" method="POST">
							...
							<a href="update-visit/?id=<?php echo $row_c[7]; ?>" class="mb-6 btn-floating waves-effect waves-light orange darken-1">
