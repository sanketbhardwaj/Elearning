...
<head>
    ...
    <title><?php echo $row_title[3]; ?> | List of Payments</title>
          ...
          <div class="row">
            ...
            <div class="col s12">
              <table id="data-table-simple" class="display">
				...
				$sql_c="select * from transaction where staff_uid = '".$_SESSION['staff_uid']."' AND reminder_date<='".$date_time."' AND transaction_status = 'Pending' ORDER BY id DESC";
				...
				?>
                  <tr>
					...
					<td><a href="pay-now/?client=<?php echo $row_c[4]."&product=".$row_c[3]."&id=".$row_c[1]; ?>" class="mb-6 btn waves-effect waves-light orange darken-1">Pay Now</a></td>
