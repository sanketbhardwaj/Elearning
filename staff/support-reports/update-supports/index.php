...
if(isset($_POST['btn_update'])){
	...
	$q="Update supports set client_uid = '".$_POST['text_client_uid']."', issue = '".$_POST['text_issue']."', solve_by = '".$_POST['text_solve_by']."', remark = '".$_POST['text_remark']."', call_duration = '".$_POST['text_call_duration']."', answer = '".$_POST['text_answer']."', url = '".$_POST['text_url']."', file = '".$file_names."' where uid='".$_GET['id']."'";
	$r=mysqli_query($cn,$q);
	if($r){
