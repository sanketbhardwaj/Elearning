...
if(isset($_POST['btn_delete'])){
	$q="Delete from supports where uid = '".$_POST['uid']."'";
	$r=mysqli_query($cn,$q);
...
<head>
    ...
    <title><?php echo $row_title[3]; ?> | List of Supports</title>
    ...
    <div class="col s12 m12 l12">
      <div id="button-trigger" class="card card card-default scrollspy">
        <div class="card-content">
          <h4 class="card-title">All Supports</h4>
          <div class="row">
            ...
            <div class="col s12">
              <table id="data-table-simple" class="display">
                ...
                <tbody>
				<?php
				$sql_c="select issue, support_uid, client_uid, solve_by, is_solve, remark, call_duration, uid from supports where support_uid = '".$_SESSION['staff_uid']."'";
				...
				while($row_c=mysqli_fetch_array($result_c))
				{
					...
					$sql_ticket="select uid from ticket_question where issue = '$row_c[0]'";
					$result_ticket=mysqli_query($cn,$sql_ticket);
					$row_ticket=mysqli_fetch_array($result_ticket);
				?>
                  <tr style="<?php
				  if($row_c[4]=="Pending"){ echo "color:red;"; }elseif($row_c[4]=="In Progress") { echo "color:orange;"; }elseif($row_c[4]=="Completed") { echo "color:green;"; } ?>">
                    <td><?php echo $f;?></td>
					<td><?php echo date_format(date_create($row_c[8]),"d/m/Y h:i A");?></td>
                    <td><?php echo $row_c[0];?></td>
                    <td><?php echo $row_client[0];?></td>
                    <td><?php echo $row_client[1];?></td>
                    <td><?php echo $row_c[4];?></td>
					<td><a href="steps/?id=<?php echo $row_ticket[0]; ?>" class="mb-6 btn waves-effect waves-light green darken-1">View</a></td>
                    <td>
					<p>
						<form action="" method="POST">
							<input type="hidden" name="uid" value="<?php echo $row_c[7]; ?>">
							<a href="update-supports/?id=<?php echo $row_c[7]; ?>" class="mb-6 btn-floating waves-effect waves-light orange darken-1">
