...
if(isset($_POST['btn_save'])){
	...
	$q="INSERT INTO demo VALUES (NULL, '".$uid."','".$date_time."','".$_SESSION['staff_uid']."','".$_POST['text_client_uid']."','','','','Pending','".$_POST['text_Demo_dt']."','Active','')";
	$r=mysqli_query($cn,$q);
					...
					<form class="col s12" method="POST" action="" enctype="multipart/form-data">
					  <div class="row">
						...
						<div class="input-field col s6">
						  ...
						  <input type="date" required name="text_Demo_dt">
