...
if(isset($_POST['btn_start'])){
	...
	$q="Update training set start_on='".$date_time."' where uid = '".$_POST['uid']."'";
	$r=mysqli_query($cn,$q);
		
	?><script>if(!alert("Training Started!")) document.location = '';</script><?php
...
<head>
    ...
    <title><?php echo $row_title[3]; ?> | List of Training</title>
          ...
          <div class="row">
            ...
            <div class="col s12">
              <table id="data-table-simple" class="display">
				...
				$sql_c="select * from training where staff_uid = '".$_SESSION['staff_uid']."' AND training_date <= '".$date_time."' AND training_status = 'Pending' ORDER BY id DESC";
				...
				?>
                  <tr>
					...
					if($row_c[6]=="0000-00-00 00:00:00"){
						...
						?>
						<td><a href="end-training/?id=<?php echo $row_c[1]; ?>" class="mb-6 btn waves-effect waves-light red darken-1">End Training</a></td>
						<?php
					}
					?>
