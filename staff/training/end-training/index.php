...
if(isset($_POST['btn_save'])){
	...
	$q="Update training set remark = '".$_POST['text_remark']."', end_on='".$cur_date."', training_status='Completed', type='".$_POST['text_type']."' where uid='".$_GET['id']."'";
	$r=mysqli_query($cn,$q);
	if($r){
		?><script>if(!alert("End Training!")) document.location = '../';</script><?php
	}else{
...
<head>
    ...
    <title><?php echo $row_title[3]; ?> | End Trainings</title>
				...
				<div class="card-title">
				  <div class="row">
					<div class="col s12 m6 l10">
					  <h4 class="card-title">End Trainings</h4>
					</div>
				  </div>
				</div>
				<div id="view-icon-prefixes">
				  ...
				  <div class="row">
					<form class="col s12" method="POST" action="" enctype="multipart/form-data">
					  <div class="row">
					  <?php
						$sql_c="select * from training where uid = '".$_GET['id']."'";
