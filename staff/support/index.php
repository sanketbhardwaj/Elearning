...
if(isset($_POST['btn_reject'])){
	...
	$q="Update Tickets set follow_status='Completed' where uid = '".$_POST['uid']."'";
	$r=mysqli_query($cn,$q);
          ...
          <div class="row">
            ...
            <div class="col s12">
              <table id="data-table-simple" class="display">
				...
				$sql_c="select * from supports where support_uid = '".$_SESSION['staff_uid']."' AND is_solve='Pending' ORDER BY id DESC";
				...
				while($row_c=mysqli_fetch_array($result_c))
				{
					...
					$sql_ticket="select uid from ticket_question where issue = '$row_c[5]'";
				...
				?>
                  <tr>
					...
					<td><a href="steps/?id=<?php echo $row_ticket[0]."&ticket_id=".$row_c[1]; ?>" class="mb-6 btn waves-effect waves-light green darken-1">View</a></td>
