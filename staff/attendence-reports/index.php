          ...
          <div class="row">
            ...
            <div class="col s12">
              <table id="data-table-simple" class="display">
				...
				$sql="select * from attendence where staff_uid = '".$_SESSION['staff_uid']."' ORDER BY id DESC";
				...
				while($row=mysqli_fetch_array($result))
				{
					...
					if($row[6]!="Pending"){
					  ...
					  <tr style="color:red;<?php
						if($row[6]=="Yes"){ echo "color:red;"; }elseif($row[6]=="Late") { echo "color:orange;"; }?>">
						<td><?php echo $f;?></td>
						
						<td><?php echo date_format(date_create($row[2]),"d/m/Y");?></td>
						
						<td><?php echo date_format(date_create($row[4]),"h:i A");?></td>
						
						<td><?php
						if($row[5]!="00:00:00"){
							echo date_format(date_create($row[5]),"h:i A");?></td><?php
						}
						?>
