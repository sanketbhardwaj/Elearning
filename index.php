...
<head>
    ...
    <title><?php echo $row_title[3]; ?> | Coming Soon</title>
...
.bgimg {
  background-image: url('https://rismedia.com/wp-content/uploads/2019/11/businessman-hand-cover-wooden-home-model-insurance-concept-picture-id841147122.jpg');
  height: 100%;
...
<div class="bgimg">
  <div class="topleft">
    <p><img src="logo/<?php echo $row_title[4]; ?>" style="background:white;width:150px;"></img></p>
  </div>
  <div class="middle">
    <h1>COMING SOON</h1>
    <hr>
