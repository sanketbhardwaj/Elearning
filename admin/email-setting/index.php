...
if(isset($_POST['btn_save'])){
		...
		$q="Update email set name = '".$_POST['text_name']."', host = '".$_POST['text_host']."', port = '".$_POST['text_port']."', email = '".$_POST['text_email']."', password = '".$_POST['text_password']."'";
		$r=mysqli_query($cn,$q);
...
<head>
    ...
    <title><?php echo $row_title[3]; ?> | Update Email Setting</title>
					...
					<form class="col s12" method="POST" action="" enctype="multipart/form-data">
					  <div class="row">
						<div class="input-field col s6">
						  ...
						  <input type="text" placeholder="Enter Host" value="<?php echo $row_c[3];?>" class="validate" name="text_host">
						  <label>Host</label>
						</div>
						<div class="input-field col s6">
						  <i class="material-icons prefix">account_circle</i>
						  <input type="text" placeholder="Enter Port" value="<?php echo $row_c[4];?>" class="validate" name="text_port">
						  <label>Port</label>
						</div>
						<div class="input-field col s6">
						  <i class="material-icons prefix">account_circle</i>
						  <input type="text" placeholder="Enter Email" value="<?php echo $row_c[5];?>" class="validate" name="text_email">
						  <label>Email</label>
						</div>
						<div class="input-field col s6">
						  <i class="material-icons prefix">account_circle</i>
						  <input type="text" placeholder="Enter Password" value="<?php echo $row_c[6];?>" class="validate" name="text_password">
						  <label>Password</label>
						</div>
						<div class="input-field col s6">
						  <i class="material-icons prefix">account_circle</i>
						  <input type="text" placeholder="Enter Name" value="<?php echo $row_c[7];?>" class="validate" name="text_name">
						  <label>Name</label>
						</div>
