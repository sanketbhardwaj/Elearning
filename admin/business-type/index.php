...
if(isset($_POST['btn_delete'])){
	...
	$q="Delete from business_type where uid = '".$_POST['uid']."'";
	$r=mysqli_query($cn,$q);
...
<head>
    ...
    <title><?php echo $row_title[3]; ?> | Add Business Type</title>
					...
					<form class="col s12" method="POST" action="" enctype="multipart/form-data">
					  <div class="row">
						...
						<div class="input-field col s12">
						  ...
						  <input placeholder="Enter Business Type" type="text"  name="text_business_type">
