...
if(isset($_POST['btn_delete'])){
	...
	$q="Delete from admin where uid = '".$_POST['uid']."'";
	$r=mysqli_query($cn,$q);
...
<head>
    ...
    <title><?php echo $row_title[3]; ?> | List of Admin</title>
                  ...
                  <tr>
					...
					<p>
						<form action="" method="POST">
							...
							<a href="update-admin/?id=<?php echo $row_c[1]; ?>" class="mb-6 btn-floating waves-effect waves-light orange darken-1">
