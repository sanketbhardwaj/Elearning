...
if(isset($_POST['btn_update'])){
	...
	if(file_exists($_FILES['text_profile']['tmp_name'])){
		...
		$q="Update admin set profile_pic = '".$profilepic."' where uid='".$_GET['id']."'";
		$r=mysqli_query($cn,$q);
	}
	
	$q="Update admin set name = '".$_POST['text_name']."', mobile = '".$_POST['text_mobile']."', email = '".$_POST['text_email']."', password = '".$_POST['text_password']."', type = '".$_POST['text_admin_type']."' where uid='".$_GET['id']."'";
	$r=mysqli_query($cn,$q);
	if($r){
		?><script>if(!alert("Updated!")) document.location = '../';</script><?php
	}else{
		?><script>if(!alert("Mobile No. or Email Already Exist!")) document.location = '../';</script><?php
	}
...
<head>
    ...
    <title><?php echo $row_title[3]; ?> | Update Admin</title>
				...
				<div id="view-icon-prefixes">
				  ...
				  <div class="row">
					<form class="col s12" method="POST" action="" enctype="multipart/form-data">
					  <div class="row">
					  <?php
						$sql_c="select * from admin where uid = '".$_GET['id']."'";
					  ...
					  ?>
						...
						<div class="input-field col s6">
						  ...
						  <input type="text" placeholder="Enter 10 Digit Mobile Number" value="<?php echo $row_c[4];?>" class="validate" name="text_mobile"  size="10" maxlength="10" onkeypress="return event.charCode >= 48 && event.charCode <= 57">
						  <label>Mobile Number</label>
						</div>
						
						<div class="input-field col s6">
						  <i class="material-icons prefix">mail_outline</i>
						  <input type="email" placeholder="Enter Email ID" class="validate" value="<?php echo $row_c[5];?>" name="text_email">
						  <label>Email</label>
						</div>
						<div class="input-field col s6">
						  <i class="material-icons prefix">vpn_key</i>
						  <input type="text" placeholder="Enter Password" class="validate" name="text_password" value="<?php echo $row_c[6];?>" >
						...
						<?php
								if($_SESSION['admin_uid']==$row_c[1]){
						?>
						<div class="input-field col s6">
							<select name="text_admin_type" disabled >
						...
						if($row_c[9]!=""){ ?>
						<div class="input-field col s6">
						<a href="../../../images/<?php echo $row_c[9];?>">View File/Image</a>
