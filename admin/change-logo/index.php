...
if(isset($_POST['btn_save'])){
		...
		if(file_exists($_FILES['text_profile']['tmp_name'])){
			...
			$locations = "../../logo/".$profilepic;
			move_uploaded_file($_FILES['text_profile']['tmp_name'],$locations);
			$q="Update logo set logo = '".$profilepic."'";
			$r=mysqli_query($cn,$q);
		}
		
		$q="Update logo set product_name = '".$_POST['text_product_name']."'";
		$r=mysqli_query($cn,$q);
...
<head>
    ...
    <title><?php echo $row_title[3]; ?> | Update Product Details</title>
					...
					<form class="col s12" method="POST" action="" enctype="multipart/form-data">
					  <div class="row">
						<div class="input-field col s6">
						  ...
						  <input type="text" placeholder="Enter Product Name" value="<?php echo $row_c[3];?>" class="validate" name="text_product_name">
						...
						<i class="material-icons prefix">insert_drive_file</i>
							  ...
							  <div class="file-path-wrapper">
								<input class="file-path validate" placeholder="Upload Product Logo" type="text" name="text_profile">
							  </div>
							
						</div>
						<?php if($row_c[4]!=""){ ?>
						<div class="input-field col s6">
						<a href="../../logo/<?php echo $row_c[4];?>">View Logo</a>
