...
if(isset($_POST['btn_save'])){
	...
	$q="INSERT INTO quotations VALUES (NULL, '".$uid."','".$date_time."','".$_POST['text_client_uid']."','".$_POST['text_staff_uid']."','".$_POST['text_quotation']."','".$_POST['text_price']."','".$file_names."','Pending','Active')";
	$r=mysqli_query($cn,$q);
...
<head>
    ...
    <title><?php echo $row_title[3]; ?> | Add Quotation</title>
				  ...
				  <div class="row">
					<form class="col s12" method="POST" action="" enctype="multipart/form-data">
					  <div class="row">
						...
						<div class="input-field col s6">
						  <i class="material-icons prefix">phone_android</i>
						  <input type="text" placeholder="Quotation Price" class="validate" name="text_price" onkeypress="return event.charCode >= 48 && event.charCode <= 57">
