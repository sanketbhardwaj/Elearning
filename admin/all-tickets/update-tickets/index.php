...
if(isset($_POST['btn_update'])){
	...
	$q="Update tickets set support_uid = '".$_POST['text_support_uid']."', client_uid = '".$_POST['text_client_uid']."', issue = '".$_POST['text_issue']."', solve_by = '".$_POST['text_solve_by']."', remark = '".$_POST['text_remark']."', call_duration = '".$_POST['text_call_duration']."', answer = '".$_POST['text_answer']."', url = '".$_POST['text_url']."', file = '".$file_names."' where uid='".$_GET['id']."'";
	$r=mysqli_query($cn,$q);
	if($r){
						...
						<div class="input-field col s6">
							<select name="text_support_uid" >
							  <option value="" disabled selected>Choose Support Staff</option>
								...
								?>
								<option <?php if($row_c[1]==$row_ticket[3]){ echo "selected";}?> value="<?php echo $row_c[1]; ?>"><?php echo $row_c[3]; ?></option>
								<?php } ?>
