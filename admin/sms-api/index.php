...
if(isset($_POST['btn_save'])){
		...
		$q="Update sms set msg_url = '".$_POST['text_transactional_api']."' where type = 'transactional'";
		$r=mysqli_query($cn,$q);
		
		$q="Update sms set msg_url = '".$_POST['text_promotional_api']."' where type = 'promotional'";
		$r=mysqli_query($cn,$q);
...
<head>
    ...
    <title><?php echo $row_title[3]; ?> | Update SMS API</title>
				...
				<div id="view-icon-prefixes">
				  ...
				  <div class="row">
					...
					<form class="col s12" method="POST" action="" enctype="multipart/form-data">
					  ...
					  <div class="row">
					  <?php
						$sql_c="select * from sms where type='transactional'";
						$result_c=mysqli_query($cn,$sql_c);
						$row_c=mysqli_fetch_array($result_c);
					  ?>
						<div class="input-field col s6">
						<a>Note: Enter "contacts={mob}" and "msg={message}"</a>
						</div>
						
						<div class="input-field col s12">
						  <i class="material-icons prefix">location_on</i>
						  <textarea name="text_transactional_api" placeholder="Enter API URL" class="materialize-textarea"><?php echo $row_c[3];?></textarea>
						  <label>Transactional API</label>
						</div>
							<?php
								$sql_c="select * from sms where type='promotional'";
								$result_c=mysqli_query($cn,$sql_c);
								$row_c=mysqli_fetch_array($result_c);
							?>
						<div class="input-field col s12">
						  <i class="material-icons prefix">location_on</i>
						  <textarea name="text_promotional_api" placeholder="Enter API URL" class="materialize-textarea"><?php echo $row_c[3];?></textarea>
