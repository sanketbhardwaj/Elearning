...
if(isset($_POST['btn_delete'])){
	...
	$q="Delete from staff where uid = '".$_POST['uid']."'";
	$r=mysqli_query($cn,$q);
...
<head>
    ...
    <title><?php echo $row_title[3]; ?> | List of Staffs</title>
          ...
          <div class="row">
            ...
            <div class="col s12">
              <table id="data-table-simple" class="display">
                ...
                <tbody>
				<?php
				$sql_c="select name, email, mobile1, dept, uid, date_time from staff";
                  ...
                  <tr>
					...
					<p>
						<form action="" method="POST">
							...
							<a href="update-staff/?id=<?php echo $row_c[4]; ?>" class="mb-6 btn-floating waves-effect waves-light orange darken-1">
