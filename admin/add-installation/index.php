...
if(isset($_POST['btn_save'])){
	...
	$q="INSERT INTO installation VALUES (NULL, '".$uid."','".$date_time."','".$_POST['text_staff_uid']."','".$_POST['text_client_uid']."','','','','Pending','".$_POST['text_installation_dt']."','Active','')";
	$r=mysqli_query($cn,$q);
...
<head>
    ...
    <title><?php echo $row_title[3]; ?> | Add Installation</title>
				...
				<div class="card-title">
				  <div class="row">
					<div class="col s12 m6 l10">
					  <h4 class="card-title">Add Installation</h4>
					</div>
				  </div>
				</div>
					  ...
					  <div class="row">
						...
						<div class="input-field col s6">
							<select name="text_staff_uid" >
							  <option value="" disabled selected>Choose Staff for Installation</option>
								<?php
							...
							<label>Select Staff for Installation</label>
					    </div>
						
						
						<div class="input-field col s6">
						  <i class="material-icons prefix">date_range</i>
						  <input type="date"  name="text_installation_dt">
