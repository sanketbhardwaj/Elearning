...
if(isset($_POST['btn_save'])){
	...
	$q="INSERT INTO visits VALUES (NULL, '".$uid."','".$date_time."','".$_POST['text_staff_uid']."','".$_POST['text_client_uid']."','','','','','','','','Pending','".$_POST['text_visit_dt']."','Active','')";
	$r=mysqli_query($cn,$q);
...
<head>
    ...
    <title><?php echo $row_title[3]; ?> | Add Visit</title>
					  ...
					  <div class="row">
						...
						<div class="input-field col s6">
							<select name="text_staff_uid" >
							  <option value="" disabled selected>Choose Staff for Visit</option>
								<?php
							...
							<label>Select Staff for Visit</label>
					    </div>
						
						
						<div class="input-field col s6">
						  <i class="material-icons prefix">date_range</i>
						  <input type="date"  name="text_visit_dt">
