...
if(isset($_POST['btn_update'])){
	...
	$q="Update client set name = '".$_POST['text_name']."', telephone = '".$_POST['text_phone']."', business_name = '".$_POST['text_business_name']."', business_type = '".$_POST['text_business_type']."', business_category = '".$_POST['text_business_category']."', lead_source = '".$_POST['text_lead_source']."', reference_name = '".$_POST['text_reference_name']."', sales_uid = '".$_POST['text_sales_uid']."', mobile1 = '".$_POST['text_mobile']."', mobile2 = '".$_POST['text_alternet_mobile']."', whatsapp_no = '".$_POST['text_whatsapp']."', email = '".$_POST['text_email']."', gender = '".$_POST['radio_gender']."', address = '".$_POST['text_address']."', city = '".$_POST['text_city']."', state = '".$_POST['text_state']."', pincode = '".$_POST['text_pincode']."', support_uid = '".$_POST['text_support_uid']."', area = '".$_POST['text_area']."' where uid='".$_GET['id']."'";
	$r=mysqli_query($cn,$q);
	if($r){
...
<head>
    ...
    <title><?php echo $row_title[3]; ?> | Update Clients</title>
				...
				<div class="card-title">
				  <div class="row">
					<div class="col s12 m6 l10">
					  <h4 class="card-title">Update Clients</h4>
					</div>
				  </div>
				</div>
				<div id="view-icon-prefixes">
				  ...
				  <div class="row">
					<form class="col s12" method="POST" action="" enctype="multipart/form-data">
					  <div class="row">
					  <?php
						$sql_c="select * from client where client_status = 'Confirmed' AND uid = '".$_GET['id']."'";
					  ...
					  ?>
						...
						<div class="input-field col s6">
							<select name="text_support_uid" >
								...
								while($row_s=mysqli_fetch_array($result_s)){
								?>
								<option <?php if($row_c[26]==$row_s[1]){ echo "selected";}?> value="<?php echo $row_s[1]; ?>"><?php echo $row_s[3]; ?></option>
								<?php } ?>
