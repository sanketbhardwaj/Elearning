...
if(isset($_POST['btn_save'])){
	...
	$q="INSERT INTO demo VALUES (NULL, '".$uid."','".$date_time."','".$_POST['text_staff_uid']."','".$_POST['text_client_uid']."','','','','Pending','".$_POST['text_demo_dt']."','Active','')";
	$r=mysqli_query($cn,$q);
...
<head>
    ...
    <title><?php echo $row_title[3]; ?> | Add Demo</title>
					  ...
					  <div class="row">
						...
						<div class="input-field col s6">
							<select name="text_staff_uid" >
							  <option value="" disabled selected>Choose Staff for Demo</option>
								<?php
							...
							<label>Select Staff for Demo</label>
					    </div>
						
						
						<div class="input-field col s6">
						  <i class="material-icons prefix">date_range</i>
						  <input type="date"  name="text_demo_dt">
