   ...
   <!--card stats start-->
    ...
    <div class="col s12 m12 l12">
      <div id="button-trigger" class="card card card-default scrollspy">
		...
		<?php
		$sql_bname="select name, business_name from client where uid='".$_GET['id']."'";
		$result_bname=mysqli_query($cn,$sql_bname);
		$row_bname=mysqli_fetch_array($result_bname);
		?>
		<b>Business Name: <?php echo $row_bname[1]; ?>
		<br>Person Name: <?php echo $row_bname[0]; ?></b>
          ...
          <div class="row">
            ...
            <div class="col s12">
              <table id="data-table-simple" class="display">
                ...
                <tbody>
				<?php
				$sql_c="select * from followups where client_uid = '".$_GET['id']."'";
				...
				?>
                  <tr style="<?php
				  if($row_c[5]=="Pending"){ echo "color:red;"; }elseif($row_c[5]=="In Progress") { echo "color:orange;"; }elseif($row_c[5]=="Completed") { echo "color:green;"; } ?>">
                    <td><?php echo $f;?></td>
					...
					<td><?php
					if($row_c[7]!="0000-00-00"){
						echo date_format(date_create($row_c[7]),"d/m/Y");
					}
					?></td>
