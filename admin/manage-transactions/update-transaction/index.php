...
if(isset($_POST['btn_update'])){
	...
	$q="Update visits set remark = '".$_POST['text_remark']."', visit_status = '".$_POST['text_transaction_status']."', visit_date = '".$_POST['text_transaction_date']."', type = '".$_POST['text_transaction_type']."', staff_uid = '".$_POST['text_staff_uid']."', client_uid = '".$_POST['text_client_uid']."' where uid='".$_GET['id']."'";
	$r=mysqli_query($cn,$q);
	if($r){
...
<head>
    ...
    <title><?php echo $row_title[3]; ?> | View Transactions</title>
				...
				<div id="view-icon-prefixes">
				  ...
				  <div class="row">
					<form class="col s12" method="POST" action="" enctype="multipart/form-data">
					  <div class="row">
					  <?php
						$sql_transaction="select * from transaction where uid = '".$_GET['id']."'";
						$result_transaction=mysqli_query($cn,$sql_transaction);
						$row_transaction=mysqli_fetch_array($result_transaction);
					  ?>
						<div class="input-field col s6">
							<select name="text_staff_uid" disabled>
							  <option value="" disabled selected>Choose Staff</option>
								...
								?>
								<option <?php if($row_c[1]==$row_transaction[5]){ echo "selected";}?> value="<?php echo $row_c[1]; ?>"><?php echo $row_c[3]; ?></option>
								<?php } ?>
						...
						<div class="input-field col s6">
							<select name="text_client_uid" disabled>
							  <option value="" disabled selected>Choose Client</option>
								...
								while($row_c=mysqli_fetch_array($result_c)){
								?>
								<option <?php if($row_c[1]==$row_transaction[4]){ echo "selected";}?> value="<?php echo $row_c[1]; ?>"><?php echo $row_c[3]; ?></option>
								<?php } ?>
						...
						<?php
						$sql_c="select * from client_staff where uid = '".$row_transaction[3]."'";
						$result_c=mysqli_query($cn,$sql_c);
						$row_c=mysqli_fetch_array($result_c);
						?>
						<div class="input-field col s6">
						  <i class="material-icons prefix">account_circle</i>
						  <input type="text" disabled value="<?php echo $row_c[27]." (".$row_c[17].")";?>" class="validate">
						  <label>Software</label>
						</div>
						<div class="input-field col s6">
						  <i class="material-icons prefix">account_circle</i>
						  <input type="text" disabled value="<?php echo $row_transaction[6];?>" class="validate">
						  <label>Payment</label>
						</div>
						<div class="input-field col s6">
						  <i class="material-icons prefix">account_circle</i>
						  <input type="text" disabled value="<?php echo $row_transaction[7];?>" class="validate">
						  <label>Payment Mode</label>
						</div>
						<div class="input-field col s6">
						  <i class="material-icons prefix">account_circle</i>
						  <input type="text" disabled value="<?php echo $row_transaction[8];?>" class="validate">
						  <label>Payment ID</label>
						</div>
						<div class="input-field col s6">
						  <i class="material-icons prefix">account_circle</i>
						  <input type="text" disabled value="<?php echo $row_transaction[9];?>" class="validate">
						  <label>Reminder Date</label>
						</div>
						<div class="input-field col s6">
						  <i class="material-icons prefix">account_circle</i>
						  <input type="text" disabled value="<?php echo $row_transaction[11];?>" class="validate">
