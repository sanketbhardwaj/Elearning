          ...
          <div class="row">
            ...
            <div class="col s12">
              <table id="data-table-simple" class="display">
				...
				$sql="select * from attendence where (present='Yes' || present='Late') and application != 'Yes' ORDER BY id DESC";
				...
				?>
                  <tr>
					...
					<td><?php echo date_format(date_create($row[4]),"h:i A");?><br><a target="_blank" href="../../images/<?php echo $row[7];?>">View Image</a></td>
					<td><?php
					if($row[16]==""){
						echo "In Office";
					}else{
						echo "Outside Office ";?><br><a target="_blank" href="http://www.google.com/maps/place/<?php echo $row[10].",".$row[11];?>">View Location</a><br><?php echo $row[16];
					}
					?></td>
					<td><?php
					if($row[5]!="00:00:00"){
						echo date_format(date_create($row[5]),"h:i A");?><br><a target="_blank" href="../../images/<?php echo $row[20];?>">View Image</a></td><?php
					}
					?>
					<td><?php
					if($row[5]!="00:00:00"){
						if($row[19]==""){
							...
							echo "Outside Office ";?><br><a target="_blank" href="http://www.google.com/maps/place/<?php echo $row[17].",".$row[18];?>">View Location</a><br><?php echo $row[19];
						}
					}
