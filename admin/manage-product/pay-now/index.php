...
if(isset($_POST['btn_save'])){
	...
	$q="INSERT INTO transaction VALUES (NULL, '".$uid."','".$date_time."','".$_GET['product']."','".$_GET['client']."','".$_GET['staff']."','".$_POST['text_payment']."','".$_POST['text_payment_mode']."','".$_POST['text_payment_id']."','".$_POST['text_next_date']."','Active','Completed')";
	$r=mysqli_query($cn,$q);
	if($r){
		?><script>if(!alert("Paid!")) document.location = '../';</script><?php
	}else{
