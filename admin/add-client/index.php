...
if(isset($_POST['btn_save'])){
	...
	if($row[0]!=0){
		...
		$q="INSERT INTO transaction VALUES (NULL, '".$uid."','".$date_time."','".$uid."','".$uid."','".$_POST['text_sales_uid']."','".$_POST['text_advance_payment']."','".$_POST['text_payment_mode']."','".$_POST['text_payment_id']."','".$reminder_dt."','Active','Completed')";
		$r=mysqli_query($cn,$q);
		...
		$q="INSERT INTO quotations VALUES (NULL, '".$uid."','".$date_time."','".$uid."','".$_POST['text_sales_uid']."','".$_POST['text_quotation']."','".$_POST['text_sw_final_price']."','".$file_names."','Confirmed','Active')";
		$r=mysqli_query($cn,$q);
		...
		$q="INSERT INTO invoices VALUES (NULL, '".$uid."','".$date_time."','".$uid."','".$_POST['text_sales_uid']."','".$_POST['text_invoice']."','".$_POST['text_sw_final_price']."','".$file_names."','Confirmed','Active')";
		$r=mysqli_query($cn,$q);
...
<head>
    ...
    <title><?php echo $row_title[3]; ?> | Add Client</title>
				  ...
				  <div class="row">
					<form class="col s12" method="POST" action="" enctype="multipart/form-data">
					  <div class="row">
						...
						<div class="input-field col s6">
						  <i class="material-icons prefix">phone_android</i>
						  <input type="text" placeholder="Enter 11 Digit Telephone Number" class="validate" name="text_phone" size="11" maxlength="11" onkeypress="return event.charCode >= 48 && event.charCode <= 57">
						...
						<div class="input-field col s6">
						  ...
						  <input type="text" placeholder="Enter Quotation No" class="validate" name="quotation_no" >
						...
						<div class="input-field col s6">
						  ...
						  <input type="text" placeholder="Enter Software Quotation Price" class="validate" name="text_sw_quote_price"  onkeypress="return event.charCode >= 48 && event.charCode <= 57">
