...
if(isset($_POST['btn_update'])){
	...
	$q="Update installation set remark = '".$_POST['text_remark']."', visit_status = '".$_POST['text_installation_status']."', visit_date = '".$_POST['text_installation_date']."', type = '".$_POST['text_installation_type']."', staff_uid = '".$_POST['text_staff_uid']."', client_uid = '".$_POST['text_client_uid']."' where uid='".$_GET['id']."'";
	$r=mysqli_query($cn,$q);
	if($r){
...
<head>
    ...
    <title><?php echo $row_title[3]; ?> | Update Installation</title>
				...
				<div id="view-icon-prefixes">
				  ...
				  <div class="row">
					<form class="col s12" method="POST" action="" enctype="multipart/form-data">
					  <div class="row">
					  <?php
						$sql_installation="select * from installation where uid = '".$_GET['id']."'";
						$result_installation=mysqli_query($cn,$sql_installation);
						$row_installation=mysqli_fetch_array($result_installation);
					  ?>
						<div class="input-field col s6">
							<select name="text_staff_uid">
							  <option value="" disabled selected>Choose Staff</option>
								...
								?>
								<option <?php if($row_c[1]==$row_installation[3]){ echo "selected";}?> value="<?php echo $row_c[1]; ?>"><?php echo $row_c[3]; ?></option>
								<?php } ?>
							  
							</select>
							<label>Assign Staff Staff</label>
					    </div>
						<div class="input-field col s6">
							<select name="text_client_uid" >
							  <option value="" disabled selected>Choose Client</option>
								...
								while($row_c=mysqli_fetch_array($result_c)){
								?>
								<option <?php if($row_c[1]==$row_installation[4]){ echo "selected";}?> value="<?php echo $row_c[1]; ?>"><?php echo $row_c[10]; ?></option>
								<?php } ?>
						...
						<div class="input-field col s6">
						  ...
						  <input type="text" disabled value="<?php echo $row_installation[6];?>" class="validate">
						  <label>Start On</label>
						</div>
						<div class="input-field col s6">
						  <i class="material-icons prefix">account_circle</i>
						  <input type="text" disabled value="<?php echo $row_installation[7];?>" class="validate">
						  <label>Start Latitude</label>
						</div>
						<div class="input-field col s6">
						  <i class="material-icons prefix">account_circle</i>
						  <input type="text" disabled value="<?php echo $row_installation[8];?>" class="validate">
						  <label>Start Longitude</label>
						</div>
						<div class="input-field col s6">
						  <i class="material-icons prefix">account_circle</i>
						  <input type="text" disabled value="<?php echo $row_installation[9];?>" class="validate">
						  <label>End On</label>
						</div>
						<div class="input-field col s6">
						  <i class="material-icons prefix">account_circle</i>
						  <input type="text" disabled value="<?php echo $row_installation[10];?>" class="validate">
						  <label>End Latitude</label>
						</div>
						<div class="input-field col s6">
						  <i class="material-icons prefix">account_circle</i>
						  <input type="text" disabled value="<?php echo $row_installation[11];?>" class="validate">
						...
						<div class="input-field col s12">
						  ...
						  <textarea name="text_remark" placeholder="Enter Remark" class="materialize-textarea"><?php echo $row_installation[5];?></textarea>
						  <label>Remark</label>
						</div>
						<div class="input-field col s6">
							<select name="text_installation_status">
								<option value="" disabled selected>Select Status</option>
								<option <?php if("Pending"==$row_installation[12]){ echo "selected";}?> value="Pending">Pending</option>
								<option <?php if("Completed"==$row_installation[12]){ echo "selected";}?> value="Completed">Completed</option>
							</select>
							<label>Installation Status</label>
					    </div>
						<div class="input-field col s6">
							<select name="text_installation_type">
								<option value="" disabled selected>Select Type</option>
								<option <?php if("Online"==$row_installation[15]){ echo "selected";}?> value="Online">Online</option>
								<option <?php if("Offline"==$row_installation[15]){ echo "selected";}?> value="Offline">Offline</option>
							</select>
							<label>Installation Type</label>
					    </div>
						<div class="input-field col s6">
						  <i class="material-icons prefix">cake</i>
						  <input type="date" value="<?php if($row_c[13]!="1970-01-01"){ echo $row_c[13]; }?>" name="text_installation_date">
