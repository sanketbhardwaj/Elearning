...
$ext = "../";
$menu = "all_installation";

if(isset($_POST['btn_delete'])){
	
	
	$q="Delete from installation where uid = '".$_POST['uid']."'";
	$r=mysqli_query($cn,$q);
          ...
          <div class="row">
            ...
            <div class="col s12">
              <table id="data-table-simple" class="display">
                ...
                <tbody>
				<?php
				$sql_c="select installation_date, staff_uid, client_uid, installation_status, start_on, end_on, remark, uid from installation";
				  ...
				  if($row_c[3]=="Pending"){ echo "color:red;"; }elseif($row_c[3]=="In Progress") { echo "color:orange;"; }elseif($row_c[3]=="Completed") { echo "color:green;"; } ?>">
					...
					<p>
						<form action="" method="POST">
							...
							<a href="update-installation/?id=<?php echo $row_c[7]; ?>" class="mb-6 btn-floating waves-effect waves-light orange darken-1">
