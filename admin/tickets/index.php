...
if(isset($_POST['btn_save'])){
	...
	$q="INSERT INTO ticket_question VALUES (NULL, '".$uid."','".$date_time."','".$_POST['text_issue']."','".$_POST['text_answer']."','".$_POST['text_url']."','Active')";
	$r=mysqli_query($cn,$q);
	?><script>if(!alert("Saved!")) document.location = '';</script><?php
}
if(isset($_POST['btn_delete'])){
	
	$q="Delete from ticket_question where uid = '".$_POST['uid']."'";
	$r=mysqli_query($cn,$q);
...
<head>
    ...
    <title><?php echo $row_title[3]; ?> | Add Tickets</title>
				...
				<div class="card-title">
				  <div class="row">
					<div class="col s12 m6 l10">
					  <h4 class="card-title">Add Ticket Master</h4>
					</div>
				  </div>
				</div>
          ...
          <div class="row">
            ...
            <div class="col s12">
              <table id="data-table-simple" class="display">
                ...
                <tbody>
				<?php
				$sql_c="select * from ticket_question";
				...
				?>
                  <tr>
                    ...
                    <td><a href="ticket-steps/?id=<?php echo $row_c[1]; ?>" class="mb-6 btn waves-effect waves-light green darken-1">Add Steps</a></td>
					<td>
					<p>
