...
<head>
    ...
    <title><?php echo $row_title[3]; ?> | Add Steps</title>
					...
					<form class="col s12" method="POST" action="" enctype="multipart/form-data">
					  <div class="row">
						...
						<div class="input-field col s12">
						  ...
						  <textarea name="text_content" id="issue" placeholder="Enter Content" class="materialize-textarea"></textarea>
						  <label>Content</label>
						</div>
						...
						<i class="material-icons prefix">insert_drive_file</i>
							  ...
							  <div class="file-path-wrapper">
								<input class="file-path validate" placeholder="File" type="text" name="text_profile_picture">
							  </div>
              ...
              <table id="data-table-simple" class="display">
				...
				?>
                  <tr>
                    ...
                    <td><a href="../../../images/<?php echo $row_c[5];?>">View Image</a></td>
                    <td>
					<p>
