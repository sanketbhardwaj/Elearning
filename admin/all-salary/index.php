...
<head>
    ...
    <title><?php echo $row_title[3]; ?> | List of Salaries</title>
          ...
          <div class="row">
            ...
            <div class="col s12">
              <table id="data-table-simple" class="display">
                ...
                <tbody>
				<?php
				$sql_c="select * from staff_salary";
				...
				{
					$f = $f+1;
					$sql_staff="select name from staff where uid = '$row_c[3]'";
				...
				?>
                  <tr>
                    ...
                    <td>
					<p>
						<a class="mb-6 btn-floating waves-effect waves-light orange darken-1">
							<i class="material-icons dp48">edit</i>
						</a>
						<a class="mb-6 btn-floating waves-effect waves-light red darken-1">
