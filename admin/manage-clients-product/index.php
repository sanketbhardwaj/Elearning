          ...
          <div class="row">
            <div class="col s12">
              <table id="data-table-simple" class="display">
                ...
                <tbody>
				<?php
				$sql_c="select * from client_staff where software_status != 'Pending' AND client_uid = '".$_GET['id']."'";
				...
				?>
                  <tr>
					...
					if($row_c[21]!=0){
						?>
						<a href="pay-now/?product=<?php echo $row_c[1]."&staff=".$row_c[4]."&client=".$row_c[3]; ?>" class="mb-6 btn waves-effect waves-light green darken-1">Pay Now</a>
						<?php
					}
					?>
					...
					if($days<=15){
						?>
						<a href="renew-software/?product=<?php echo $row_c[1]."&client=".$row_c[3]; ?>" class="mb-6 btn waves-effect waves-light green darken-1">Pay Now</a>
						<?php
					}
					?>
