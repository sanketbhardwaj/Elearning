...
if(isset($_POST['btn_save'])){
	...
	$q="INSERT INTO invoices VALUES (NULL, '".$uid."','".$date_time."','".$_POST['text_client_uid']."','".$_POST['text_staff_uid']."','".$_POST['text_invoice']."','".$_POST['text_price']."','".$file_names."','Confirmed','Active')";
	$r=mysqli_query($cn,$q);
...
<head>
    ...
    <title><?php echo $row_title[3]; ?> | Add invoice</title>
					...
					<form class="col s12" method="POST" action="" enctype="multipart/form-data">
					  <div class="row">
						...
						<div class="input-field col s6">
						  ...
						  <input type="text" placeholder="Invoice Number" class="validate" name="text_invoice" onkeypress="return event.charCode >= 48 && event.charCode <= 57">
						  <label>invoice Number</label>
						</div>
						<div class="input-field col s6">
						  <i class="material-icons prefix">phone_android</i>
						  <input type="text" placeholder="Invoice Price" class="validate" name="text_price" onkeypress="return event.charCode >= 48 && event.charCode <= 57">
						...
						<i class="material-icons prefix">insert_drive_file</i>
							  ...
							  <div class="file-path-wrapper">
								<input class="file-path validate" placeholder="invoice File" type="text" name="text_profile_picture">
							  </div>
