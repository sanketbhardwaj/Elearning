...
if(isset($_POST['btn_update'])){
	...
	$q="Update visits set remark = '".$_POST['text_remark']."', visit_status = '".$_POST['text_visits_status']."', visit_date = '".$_POST['text_visits_date']."', type = '".$_POST['text_visits_type']."', staff_uid = '".$_POST['text_staff_uid']."', client_uid = '".$_POST['text_client_uid']."' where uid='".$_GET['id']."'";
	$r=mysqli_query($cn,$q);
	if($r){
						...
						<div class="input-field col s6">
							<select name="text_staff_uid">
							  <option value="" disabled selected>Choose Staff</option>
								...
								?>
								<option <?php if($row_c[1]==$row_visits[3]){ echo "selected";}?> value="<?php echo $row_c[1]; ?>"><?php echo $row_c[3]; ?></option>
								<?php } ?>
