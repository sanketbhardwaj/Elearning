...
$sql="select * from transaction where staff_uid = '".$_POST['staff_uid']."' AND transaction_status != 'Pending' ORDER BY id DESC";
...
while ($row_sql=mysqli_fetch_row($result1)) 
{
	...
	$sql = "SELECT SUM(payment) FROM `transaction` where id BETWEEN '1' AND '".$row_sql[0]."' AND staff_uid = '".$_POST['staff_uid']."' AND transaction_status != 'Pending' ORDER BY id DESC";
